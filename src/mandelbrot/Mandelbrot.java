...
public class Mandelbrot {
   ...
   */
  public static double RADIUS = 1e3;
  ...
  public double divergence(Complex c) {
    ...
    Function<Complex,Complex> f = z -> z.pow(2).add(c);
  ...
  private double smoothIterationCount(int countIterations, Complex z) {
    ...
    double smooth = (double) countIterations - Math.log(x) / Math.log(DEGREE);
    return smooth;
  }
   ...
   */
  public boolean isDiverging(Complex z) {
    return z.modulus2() > RADIUS2;
  }
   ...
   */
  public boolean isConvergent(Complex c) {
